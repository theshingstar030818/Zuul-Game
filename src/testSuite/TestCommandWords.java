...
public class TestCommandWords extends TestCase {
	...
	public void testGetReverse() {
		...
		assertEquals(new Command(REVERSE, null).getCommandWord(), cw
				.getReverse(new Command(REVERSIBLE, null)).getCommandWord());
		assertEquals(new Command(REVERSIBLE, null).getCommandWord(), cw
				.getReverse(new Command(REVERSE, null)).getCommandWord());
